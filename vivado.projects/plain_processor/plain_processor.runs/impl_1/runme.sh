...
HD_PWD='Y:/sha256.hw.accelerator/vivado.projects/plain_processor/plain_processor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log plain_processor_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source plain_processor_wrapper.tcl -notrace
