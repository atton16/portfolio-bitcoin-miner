...
HD_PWD='Y:/sha256.hw.accelerator/vivado.projects/plain_processor/plain_processor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log plain_processor_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source plain_processor_wrapper.tcl
